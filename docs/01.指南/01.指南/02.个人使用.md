...
1、入站列表：选择你的入站节点，点击【Sniffing】 滑动【开启】，其他默认设置不用划开。（开启流量嗅探）

2、Xray设置：基础设置--常规设置--Freedom 协议策略--选择【UseIpv4】.（如果你默认使用Freedom，按此选择，如果设置了指定的出站策略，自行对应修改）

3、Xray设置：DNS设置--常规设置--启用DNS--划开，查询策略--选择【UseIpv4】.

4、Xray设置：DNS设置--DNS栏，点击【添加服务器】，先添加默认1.1.1.1和8.8.8.8不需要修改其他，然后再新增【地址】--输入网站提供的DNS，查询策略选择【UseIpv4】，核心【域】参数点+号，每个+号可以填写一个域规则，比如第一个写入geosite:netflix，继续点+号，写入geosite:disney，继续点+号，写入gemini.google.com，以此类推.添加所有需要分流的域名后，点击确认.(其他参数无需填写，默认即可)

5、点击左上角【保存】，点击【重新启动Xray】。
