...
4、Xray设置：DNS设置--DNS栏，点击【添加服务器】，【地址】--输入网站提供的DNS，查询策略选择【UseIpv4】，核心【域】参数点+号，每个+号可以填写一个域规则，比如第一个写入geosite:netflix，继续点+号，写入geosite:disney，继续点+号，写入gemini.google.com，以此类推.添加所有需要分流的域名后，点击确认.(其他参数无需填写，默认即可)
